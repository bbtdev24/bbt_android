...
public class tabel_izin_non_full_day extends AppCompatActivity {
    ...
    private void loadPlayer() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "http://36.88.110.134:27/bbt_api/rest_server/pengajuan/izin_non_full_day/index?nik_baru=" + nik_baru,
