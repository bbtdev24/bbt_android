...
public class form_cuti_tahunan extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener{
    ...
    String string_nip_karyawan, string_lokasi_karyawan, string_jabatan_karyawan,
            string_nama_karyawan, string_nama_divisi, string_id_jabatan, string_id_bagian, string_id_divisi, string_no_urut_karyawan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cekdetail = (Button) findViewById(R.id.download);
        ceklihat = (Button) findViewById(R.id.cekmap);
                        ...
                        final StringRequest stringRequest2 = new StringRequest(Request.Method.POST, "https://ess.banktanah.id/bbt_api/rest_server/Push_Notification/push_notif_v1.php",
                            ...
                            protected Map<String, String> getParams() throws AuthFailureError {
                                ...
                                if (diterima.isChecked()) {
                                    ...
                                    params.put("body", "Pengajuan CUTI TAHUNAN anda sudah di APPROVE");
