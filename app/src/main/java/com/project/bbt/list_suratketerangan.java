...
public class list_suratketerangan extends AppCompatActivity {
    ...
    private void getSK() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "http://36.88.110.134:27/bbt_api/rest_server/pengajuan/SK/index_get_pengajuan_sk?nik_baru=" + nik_baru,
