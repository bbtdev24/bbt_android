...
public class approval_cuti_khusus_yes extends AppCompatActivity {
    ...
    private void approvedinas() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://ess.banktanah.id/bbt_api/rest_server/pengajuan/cuti_khusus/index_atasan?jabatan_struktur=" + id,
