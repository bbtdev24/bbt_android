...
import com.project.bbt.Item.dinasnonfulldaymodel;
...
public class dinasnonfull extends AppCompatActivity {
    ...
    private void listdinasnonfullday() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://ess.banktanah.id/bbt_api/rest_server/pengajuan/dinas_non_full_day/index?nik_baru=" + nik_baru,
