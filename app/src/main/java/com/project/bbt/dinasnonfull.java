...
public class dinasnonfull extends AppCompatActivity {
    ...
    private void listdinasnonfullday() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "http://36.88.110.134:27/bbt_api/rest_server/pengajuan/dinas_non_full_day/index?nik_baru=" + nik_baru,
